          ...
          <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
              <ul class="card-body">
                ...
                <li class="active"><a href="/SWZP0070">{{menu_list[6].name}}</a></li>
    ...
    <div class="contents-body">
        ...
        <ul class="filter-con clear-fix">
          ...
          <li class="filter-item">
            <div class="item-con">담당자명/직원번호
              <input type="text" v-model="pgm_nm" style = "width: 100px">
            </div>
          </li>
          <li class="filter-item">
            <div class="item-con">
              <input type="text" v-model="pgm_id" style = "width: 100px">
            </div>
          </li>
        </ul>
      ...
      <section class="page-contents">
        <div class="multiGridWrap">
          <div class="div1">
            <div class="div-header">업무별 통합테스트현황
          ...
          <div class="div2">
            <div class="div-header">담당자별 통합테스트현황
              <div class="btn btn-filter-e" style="float: right; margin-bottom: 8px">
                <a href="#" @click="gridExcelExport">엑셀다운로드</a>
              </div>
            </div>
          ...
          <div class="div4">
            <div class="div-header">통합테스트 및 결함 미진내역
              <div class="btn btn-filter-e" style="float: right; margin-bottom: 8px">
                <a href="#" @click="gridExcelExport">엑셀다운로드</a>
              </div>
            </div>
